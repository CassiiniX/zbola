...
<html lang="en" dir="ltr">
  ...
  <script>
    function toggleMenu(){      
      if($("#mobile-menu").hasClass('animated fadeInUp')){
        $("#mobile-menu").removeClass('animated fadeInUp');
        $("#mobile-menu").addClass('animated fadeOutDown');          
      }else if($("#mobile-menu").hasClass('animated fadeOutDown')){
        $("#mobile-menu").removeClass('animated fadeOutDown');
        $("#mobile-menu").addClass('animated fadeInUp');
      }else{
        $("#mobile-menu").removeClass('animated fadeOutDown');
        $("#mobile-menu").addClass('animated fadeInUp');
        $("#mobile-menu").toggle();
